...
cd _dist/darwin-amd64/ && tar -cvzf darwin-amd64-$version.tar.gz kubectl-evict-pod
...
cd _dist/linux-amd64/  && tar -cvzf linux-amd64-$version.tar.gz kubectl-evict-pod
